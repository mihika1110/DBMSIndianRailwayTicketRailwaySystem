...
```
## ✅ Step 11: Creating Procedures for Cancellation and Upgrades

Execute the following SQL scripts to create stored procedures that handle passenger cancellations and upgrades. The `ProcessCancellation` procedure manages the cancellation of tickets and calculates refund amounts, while the `ProcessUpgrades` procedure upgrades passengers from RAC to confirmed status and from waitlist to RAC status as seats become available.
```sql
...
```
## ✅ Step 12: Booking a Train Ticket - Procedure Execution
...
```
---
## ✅ Step 13: Upgrading RAC Passengers When Seats Get Cancelled
